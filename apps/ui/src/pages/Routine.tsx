...
export default function Routine() {
    return (
        <div className="flex flex-col items-center bg-background min-h-screen relative font-inter">
            ...
            <div 
                className="relative flex flex-col justify-center items-center w-[90%] h-[450px] rounded-3xl mb-5 mt-10 bg-cover bg-center overflow-hidden"
                style={{ backgroundImage: `url('./images/fondo1.png')` }}
            >
                <div className="absolute inset-0 bg-black/20"></div>

                <h2 className="text-3xl font-bold text-white mb-2 z-10 font-inter">SÉ TU MEJOR VERSIÓN</h2>
                <p className="mt-2 text-md text-white text-center max-w-[35%] z-10 font-inter">
                ...
                <button
                    type="submit"
                    className="w-24 mt-6 rounded-full bg-transparent py-2 border border-white
                            font-semibold text-white text-md font-inter text-center
                            hover:bg-background hover:text-darkblue transition-colors
