export default function Header() {
    return (
        ...
        <div className="max-w-[1100px] mx-auto py-3 flex items-center font-inter">
            ...
            <a href="#" className="hover:text-gray-200 transition-colors">PRODUCTOS</a>
            <a href="#" className="hover:text-gray-200 transition-colors">RUTINA</a>
            ...
            <a href="#" className="border border-white text-sm py-1 px-5 rounded-full hover:bg-white hover:text-black transition-colors">
                LOG IN
            </a>
            </nav>
        </div>
